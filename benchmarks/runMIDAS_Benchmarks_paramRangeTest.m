...
for indexI = 1:50
    ...
    owningCost = rand() * 150;
    experiment = [experiment;{'modelParameters.shortName',  ['PA' num2str(indexI) '_']}];
    experiment = [experiment;{'modelParameters.aspirationsFlag',  1}];
    experiment = [experiment;{'modelParameters.runID',  'PA'}];
...
for indexI = 1:50
    ...
    owningCost = rand() * 2000;
    experiment = [experiment;{'modelParameters.shortName',  ['farmCost' num2str(indexI) '_']}];
    experiment = [experiment;{'modelParameters.aspirationsFlag',  1}];
    experiment = [experiment;{'modelParameters.runID',  'farmCost'}];
    % experiment = [experiment;{'modelParameters.placeAttachmentFlag',  1}];
    % experiment = [experiment;{'agentParameters.placeAttachmentMean', rand()}];
    % experiment = [experiment;{'agentParameters.rValueMean', rand() * 1.5}];
    % experiment = [experiment;{'mapParameters.movingCostsPerMile', rand() * 0.002}];
...
for indexI = 1:50
    ...
    owningCost = rand() * 150;
    experiment = [experiment;{'modelParameters.shortName',  ['moving' num2str(indexI) '_']}];
    experiment = [experiment;{'modelParameters.aspirationsFlag',  1}];
    experiment = [experiment;{'modelParameters.runID',  'moving'}];
    % experiment = [experiment;{'modelParameters.placeAttachmentFlag',  1}];
    % experiment = [experiment;{'agentParameters.placeAttachmentMean', rand()}];
    % experiment = [experiment;{'agentParameters.rValueMean', rand() * 1.5}];
    experiment = [experiment;{'mapParameters.movingCostPerMile', rand() * 0.1}];
    % experiment = [experiment;{'modelParameters.largeFarmCost', owningCost * 2}];
    % experiment = [experiment;{'modelParameters.smallFarmCost', owningCost}];
...
for indexI = 1:50
    ...
    owningCost = rand() * 2000;
    experiment = [experiment;{'modelParameters.shortName',  ['mem' num2str(indexI) '_']}];
    experiment = [experiment;{'modelParameters.aspirationsFlag',  1}];
    experiment = [experiment;{'modelParameters.runID',  'mem'}];
    % experiment = [experiment;{'modelParameters.placeAttachmentFlag',  1}];
    % experiment = [experiment;{'agentParameters.placeAttachmentMean', rand()}];
    % experiment = [experiment;{'agentParameters.rValueMean', rand() * 1.5}];
    % experiment = [experiment;{'mapParameters.movingCostsPerMile', rand() * 0.002}];
    ...
    % experiment = [experiment;{'agentParameters.discountRateMean',  rand() * 0.2}];
    % experiment = [experiment;{'agentParameters.numPeriodsEvaluateMean',  randperm(5,1) * 3 + 4}];
    experiment = [experiment;{'agentParameters.numPeriodsMemoryMean',  round(rand()*20 + 4)}];
