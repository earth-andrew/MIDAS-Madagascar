...
for indexI = 1:10
    ...
    tempR = rand() * 2;
    experiment = [experiment;{'modelParameters.shortName',  ['varying_risk_aversion_' num2str(tempR)]}];
    experiment = [experiment;{'modelParameters.runID',  ['VHR' num2str(tempR)]}];
    experiment = [experiment;{'agentParameters.rValueMean',  tempR}];
    experiment = [experiment;{'modelParameters.visualizeYN', 1}];
